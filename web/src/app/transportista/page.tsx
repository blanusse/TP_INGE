...
function SeccionMisOfertas({ onToast }: { onToast: (m: string) => void }) {
  ...
  return (
    <main style={{ padding: 20, flex: 1 }}>
      <div style={{ fontSize: 20, fontWeight: 700, color: "var(--color-text-primary)", marginBottom: 16 }}>Mis ofertas</div>
  ...
  return (
    <>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "var(--bg1)" }}>
        ...
        {navActivo === "Mi perfil" && <SeccionPerfil onToast={mostrarToast} userName={userName} userEmail={userEmail} mode={effectiveMode} />}
      </div>
