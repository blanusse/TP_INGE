...
- Name: registro-completo.spec.ts >> Registro — Validaciones inline >> DADO contraseña corta CUANDO intenta registrar ENTONCES muestra error de contraseña
- Location: tests/e2e/registro-completo.spec.ts:134:7
