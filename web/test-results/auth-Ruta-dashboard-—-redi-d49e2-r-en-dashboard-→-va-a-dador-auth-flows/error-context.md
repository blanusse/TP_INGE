...
- Name: auth.spec.ts >> Ruta /dashboard — redirección inteligente >> dador en /dashboard → va a /dador
- Location: tests/e2e/auth.spec.ts:124:7
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e34]:
      ...
      - heading "Iniciá sesión" [level=1] [ref=e36]
      - paragraph [ref=e37]: Ingresá con tu email y contraseña
      - generic [ref=e38]:
        - generic [ref=e39]:
          - generic [ref=e40]: Email
          - textbox "Email" [ref=e41]:
            - /placeholder: tu@email.com
            - text: dador_test@cargaback.test
        - generic [ref=e42]:
          - generic [ref=e43]: Contraseña
          - generic [ref=e44]:
            - textbox "Tu contraseña" [ref=e45]: TestPass123!
            - button "Mostrar" [ref=e46] [cursor=pointer]
        - button "¿Olvidaste tu contraseña?" [ref=e48] [cursor=pointer]
        - generic [ref=e49]: ⚠ Email o contraseña incorrectos.
        - button "Ingresar" [ref=e50] [cursor=pointer]
      - paragraph [ref=e52]:
        - text: ¿No tenés cuenta?
        - button "Registrate gratis" [ref=e53] [cursor=pointer]
  - alert [ref=e54]
```
...
```ts
  ...
  35  |     await expect(page).toHaveURL(/\/flota/, { timeout: 30_000 });
  36  |   });
  37  | 
  ...
  43  |     await expect(page).toHaveURL(/\/empleado/, { timeout: 30_000 });
  44  |   });
  45  | 
  ...
  51  |     await expect(page).toHaveURL(/\/admin/, { timeout: 30_000 });
  52  |   });
  53  | });
  54  | 
  ...
  62  |     await page.waitForURL(/\/dador/, { timeout: 30_000 });
  ...
  73  |     await page.waitForURL(/\/transportista/, { timeout: 30_000 });
  ...
  83  |     await page.waitForURL(/\/dador/, { timeout: 30_000 });
  ...
  95  |     await page.waitForURL(/\/dador/, { timeout: 30_000 });
  ...
  107 |     await page.waitForURL(/\/dador/, { timeout: 30_000 });
  108 | 
  ...
  128 |     await page.getByRole("button", { name: /Ingresar/i }).click();
> 129 |     await page.waitForURL(/\/dador/, { timeout: 30_000 });
      |                ^ Error: page.waitForURL: Test timeout of 30000ms exceeded.
  130 |     await page.goto("/dashboard");
  131 |     await expect(page).toHaveURL(/\/dador/, { timeout: 15_000 });
  132 |   });
  133 | });
  134 | 
```