...
- Name: registro-completo.spec.ts >> Registro — Validaciones inline >> DADO email inválido CUANDO escribe sin @ ENTONCES no marca como disponible
- Location: tests/e2e/registro-completo.spec.ts:128:7
