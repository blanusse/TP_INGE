...
- Name: dador.spec.ts >> Dador — Publicar nueva carga >> el formulario de nueva carga se abre correctamente
- Location: tests/e2e/dador.spec.ts:97:7
...
Locator: getByPlaceholder(/origen|ciudad de retiro|retiro/i).or(getByLabel(/origen|retiro|pickup/i))
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByPlaceholder(/origen|ciudad de retiro|retiro/i).or(getByLabel(/origen|retiro|pickup/i))
...
- main:
  - text: Mi perfil
  - separator
  - text: DT Dador Test dador_test@cargaback.test Sin verificar  0 Cargas publicadas 0 En tránsito ahora — Calificación promedio Datos de empresa Razón social Test Dador SA CUIT / CUIL 20-30000001-5 Dirección — Contacto Email dador_test@cargaback.test DNI — Teléfono — Actividad En plataforma desde 17 de mayo de 2026 Calificación Sin calificaciones aún Verificación de identidad Subí una foto del frente de tu DNI para verificar tu identidad. El número debe coincidir con el que ingresaste al registrarte. Subir foto del DNI
