...
- Name: registro-completo.spec.ts >> Registro — Dador empresa >> DADO selección Dador empresa CUANDO elige Empresa ENTONCES ve campos de CUIT y razón social
- Location: tests/e2e/registro-completo.spec.ts:77:7
...
Call log:
  - waiting for getByText('Empresa / S.R.L.')
