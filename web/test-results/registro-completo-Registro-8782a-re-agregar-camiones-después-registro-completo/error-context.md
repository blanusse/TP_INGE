...
- Name: registro-completo.spec.ts >> Registro — Transportista >> DADO formulario transportista ENTONCES muestra info sobre agregar camiones después
- Location: tests/e2e/registro-completo.spec.ts:101:7
...
Call log:
  - waiting for locator('#nombre') to be visible
