...
- Name: auth.spec.ts >> Login exitoso por rol >> empleado → redirige a /empleado
...
- textbox "Email":
  ...
  - text: empleado_test@cargaback.test
- text: Contraseña
...
> 43  |     await expect(page).toHaveURL(/\/empleado/, { timeout: 20_000 });
  ...
  129 |     await page.waitForURL(/\/dador/, { timeout: 20_000 });
  130 |     await page.goto("/dashboard");
  131 |     await expect(page).toHaveURL(/\/dador/, { timeout: 10_000 });
  132 |   });
  133 | });
  134 | 
```