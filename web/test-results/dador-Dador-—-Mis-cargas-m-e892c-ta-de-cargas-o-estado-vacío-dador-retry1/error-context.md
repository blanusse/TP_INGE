...
- Name: dador.spec.ts >> Dador — Mis cargas >> muestra lista de cargas o estado vacío
- Location: tests/e2e/dador.spec.ts:75:7
    ...
    - banner [ref=e3]:
      - generic [ref=e4]:
        ...
        - navigation [ref=e6]:
          ...
          - button "Mis cargas" [active] [ref=e11] [cursor=pointer]:
            - img [ref=e12]: 
