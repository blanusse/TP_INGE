...
- Name: registro-completo.spec.ts >> Registro — Dador personal (happy path) >> DADO selección Dador CUANDO elige Persona física ENTONCES ve formulario con campos de persona
- Location: tests/e2e/registro-completo.spec.ts:46:7
