...
- Name: registro-completo.spec.ts >> Registro — Empleado (requiere invitación) >> DADO código inválido CUANDO verifica ENTONCES muestra error
- Location: tests/e2e/registro-completo.spec.ts:171:7
...
Call log:
  - waiting for getByPlaceholder(/a1b2c3d4/i)
