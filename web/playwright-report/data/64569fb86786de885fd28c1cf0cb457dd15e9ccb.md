...
- Name: auth.spec.ts >> Logout >> dador puede cerrar sesión y queda en landing o login
...
```ts
  ...
  19  |     await expect(page).toHaveURL(/\/dador/, { timeout: 30_000 });
  20  |   });
  21  | 
  ...
  27  |     await expect(page).toHaveURL(/\/transportista/, { timeout: 30_000 });
  28  |   });
  29  | 
